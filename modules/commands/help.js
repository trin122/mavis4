  ...
  const { commands } = global.client;
    ...
    if (type) {
        ...
        if (!array.find(n => n == args[0].toLowerCase())) {
            ...
            msg = `=== 『 HELP 』 ===\n━━━━━━━━━━━━━━━━\n[⚜️] ➜ Không tìm thấy lệnh '${type}' trong hệ thống.\n[⚜️] ➜ Lệnh gần giống được tìm thấy '${checker.bestMatch.target}'`
        ...
        for (const cmd of array) {
          msg1 = `======『 𝗛𝗘𝗟𝗣 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 』======\n\n`
            msg += `[💝] ➜ 𝗧𝗵𝘂𝗼̣̂𝗰 𝗡𝗵𝗼́𝗺: ${cmd.cmdCategory.toUpperCase()}\n[🧸] ➜ 𝗧𝗼̂̉𝗻𝗴: ${cmd.nameModule.length} 𝗹𝗲̣̂𝗻𝗵\n[⚜️]➜ 𝗟𝗲̣̂𝗻𝗵 𝗻𝗮̀𝘆 𝗾𝘂𝘆𝗲̂̀𝗻 𝗵𝗮̣𝗻 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗵𝗮̣𝗻 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝗱𝘂̀𝗻𝗴: ${TextPr(cmd.permission)}\n[🔎] ➜ 𝗖𝗮́𝗰 𝗹𝗲̣̂𝗻𝗵: ${cmd.nameModule.join(", ")}\n\n`
        }
...
function TextPr(permission) {
    p = permission
    return p == 0 ? "Thành Viên" : p == 1 ? "Quản trị viên" : p = 2 ? "ADMINBOT" : "Toàn Quyền"
      }