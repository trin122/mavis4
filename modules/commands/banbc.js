...
if (body.toLowerCase() == 'nai') {
          ...
          if (vv == vvv) {
            api.sendMessage({body: "𝐂𝐡𝐨̛̀ 𝐁𝐨𝐭 𝐐𝐮𝐚̂̉𝐲 𝐂𝐚́𝐢 𝐍𝐡𝐞́ 𝐌𝐨𝐚𝐳\n 🍐 🦀 🦐 🦈 🦌", attachment: createReadStream(__dirname + "/cache/ảnh/baucua.gif")},threadID,async  (err, data)  => { 
