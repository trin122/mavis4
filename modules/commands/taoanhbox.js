...
module.exports.circle = async (image) => {
  ...
  var live = [], admin = [], i = 0;
  if(args[0] == 'help' || args[0] == '0' || args[0] == '-h') return api.sendMessage('=== 『 HELP TAOANHBOX 』 ===\n━━━━━━━━━━━━━━━━\n[⚜️]➜ Sử dụng: '+ this.config.name + ' [size avt]' + ' [mã màu]' + ' [tên nhóm (title)] || bỏ trống tất cả bot sẽ get thông tin tự động', threadID, messageID)
  /*============DOWNLOAD FONTS=============*/
  ...
  size = size-l*2;
  /*================CREATE PATH AVATAR===============*/
  api.sendMessage(`=== 『 CREATE TAOANHBOX 』 ===\n━━━━━━━━━━━━━━━━\n[🍗] ➜ Ảnh dự tính: ${participantIDs.length}\n[🍠] ➜ Size background: ${bgX} x ${bgY}\n[🥑] ➜ Size Avatar: ${size}\n[🥪] ➜ Màu: ${color}`,threadID, messageID);
