...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "pinterest.jpg")) request("https://i.imgur.com/8YHYh9e.jpg").pipe(fs.createWriteStream(dirMaterial + "pinterest.jpg"));
}
    ...
    return api.sendMessage({
      ...
      attachment: t
		...
		try {
			...
			const url = `http://toan-culi.tutoan205.repl.co/pinterest?search=${encodeURIComponent(keyword)}`;
