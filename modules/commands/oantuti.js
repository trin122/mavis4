...
module.exports.run = async function({ api, event, args, Users, Currencies }) {
    ...
    if (args[1] < 50 || isNaN(args[1])) return api.sendMessage(`[𝐕𝐒🐥] Mức đặt cược của bạn không phù hợp hoặc dưới 50 BAO`, threadID, messageID);
    if (money < coins) return api.sendMessage(`[𝐕𝐒🐥] Bạn không đủ ${coins} BAO để chơi`, threadID, messageID);
